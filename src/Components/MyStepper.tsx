...
const MyStepper = ({cost, dose, stepperValue, onIncrement, onDecrement}) => {
    ...
    return (
        <div className='grid grid-cols-3 gap-x-2 md:gap-x-16 whitespace-nowrap mt-4 rounded-md border bg-white mx-4 items-center py-0'>
            <p className='ml-2 md:ml-4 font-bold text-sm md:text-lg'>{cost} UZS</p>
